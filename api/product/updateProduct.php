...
if (isset($_POST['id']) and isset($_POST['name']) and isset($_POST['price']) and isset($_POST['description']) and isset($_POST['pict']) and isset($_POST['modif'])  ){
    ...
    if ($_POST['modif'] == 1) {
        ...
        $path = "../../images/product/".$_POST['service']."/".$name;
    }

    $product = ProductService::getInstance()->updateProduct($_POST['id'],$_POST['name'],$_POST['price'],$_POST['description'],$path,$_POST['modif']);
